...
def main():
    ...
    asada_1 = multiprocessing.Process(target=taquero_asada.Do_Tacos, args=(repartidor.Asada_Suadero_1, quesadillas_terminadas, ))
    asada_1.start()

    # Asada 2
    taquero_asada_2 = Taquero(name="Asada_2", meat="Asada-Suadero", quesadillero=quesadillero)
    asada_2 = multiprocessing.Process(target=taquero_asada_2.Do_Tacos, args=(repartidor.Asada_Suadero_2, quesadillas_terminadas, ))
    asada_2.start()

    # Adobada
    taquero_adobada = Taquero(name="Adobada", meat="Adobada", quesadillero=quesadillero)
    adobada = multiprocessing.Process(target=taquero_adobada.Do_Tacos, args=(repartidor.Adobada, quesadillas_terminadas, ))
    adobada.start()

    # Cabeza Tripa
    taquero_cabeza = Taquero(name="Cabeza_Tripa", meat="Cabeza_Tripa", quesadillero=quesadillero)
    cabeza = multiprocessing.Process(target=taquero_cabeza.Do_Tacos, args=(repartidor.Tripa_Cabeza, quesadillas_terminadas, ))
    cabeza.start()
